...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./productos/consulta-producto/consulta-producto').then((m) => m.ConsultaProducto),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./productos/ingreso-producto/ingreso-producto').then((m) => m.IngresoProducto),
  },
  {
  ...
  // Borras el import de arriba: import { ArqueosComponent } from './seccion/arqueos/arqueos';
